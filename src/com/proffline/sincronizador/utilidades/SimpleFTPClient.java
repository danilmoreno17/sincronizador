...
public class SimpleFTPClient {
    ...
    public synchronized boolean downloadFile(String localfilename) {
        try {
            System.out.println("File Name Local:" + localfilename);
    ...
    public static void main(String[] args) {
        ...
        f.setHost("10.10.10.19");
        f.setUser("proffline");
        f.setPassword("sunday*8000");
        f.setRemoteFile("proffline");
        boolean connected = f.connect();
        if (connected) {
            System.out.println("Conectó!");
            if (f.downloadFile("c:/dbproffline/mibd")) {
